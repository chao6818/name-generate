...
const SURNAME_PINYIN = {
  ...
  "谈": "tán", "茅": "máo", "庞": "páng", "纪": "jì", "屈": "qū",
  "项": "xiàng", "祝": "zhù", "蓝": "lán", "闵": "mǐn", "季": "jì",
  "麻": "má", "路": "lù", "娄": "lóu", "危": "wēi", "童": "tóng",
  "梅": "méi", "刁": "diāo", "骆": "luò", "樊": "fán", "霍": "huò",
  "虞": "yú", "支": "zhī", "柯": "kē", "昝": "zǎn", "管": "guǎn",
  "莫": "mò", "房": "fáng", "裘": "qiú", "缪": "miào", "干": "gān",
  "解": "xiè", "应": "yīng", "宗": "zōng", "宣": "xuān", "贲": "bēn",
  "郁": "yù", "单": "shàn", "杭": "háng", "洪": "hóng", "包": "bāo",
  "诸": "zhū", "左": "zuǒ", "吉": "jí", "钮": "niǔ", "嵇": "jī",
  "邢": "xíng", "滑": "huá", "荣": "róng", "翁": "wēng", "荀": "xún",
  "羊": "yáng", "於": "yū", "惠": "huì", "甄": "zhēn", "曲": "qū",
  "家": "jiā", "封": "fēng", "羿": "yì", "储": "chǔ", "靳": "jìn",
  "汲": "jí", "邴": "bǐng", "糜": "mí", "松": "sōng", "井": "jǐng",
  "富": "fù", "巫": "wū", "乌": "wū", "焦": "jiāo", "巴": "bā",
  "弓": "gōng", "牧": "mù", "隗": "kuí", "山": "shān", "谷": "gǔ",
  "车": "chē", "侯": "hóu", "宓": "mì", "蓬": "péng", "全": "quán",
  "郗": "xī", "班": "bān", "仰": "yǎng", "秋": "qiū", "仲": "zhòng",
  "伊": "yī", "宫": "gōng", "宁": "nìng", "仇": "qiú", "栾": "luán",
  "暴": "bào", "甘": "gān", "斜": "xié", "厉": "lì", "戎": "róng",
  "祖": "zǔ", "符": "fú", "詹": "zhān", "束": "shù", "幸": "xìng",
  "司": "sī", "韶": "sháo", "郜": "gào", "蓟": "jì", "薄": "bó",
  "印": "yìn", "宿": "sù", "怀": "huái", "蒲": "pú", "台": "tái",
  "从": "cóng", "鄂": "è", "索": "suǒ", "咸": "xián", "籍": "jí",
  "蔺": "lìn", "屠": "tú", "蒙": "méng", "池": "chí", "阴": "yīn",
  "胥": "xū", "能": "nài", "苍": "cāng", "双": "shuāng", "莘": "shēn",
  "党": "dǎng", "翟": "zhái", "贡": "gòng", "劳": "láo", "逄": "páng",
  "姬": "jī", "申": "shēn", "扶": "fú", "堵": "dǔ", "冉": "rǎn",
  "宰": "zǎi", "郦": "lì", "雍": "yōng", "却": "què", "璩": "qú",
  "桂": "guì", "濮": "pú", "牛": "niú", "寿": "shòu", "通": "tōng",
  "边": "biān", "扈": "hù", "燕": "yān", "冀": "jì", "郏": "jiá",
  "浦": "pǔ", "农": "nóng", "别": "bié", "庄": "zhuāng", "晏": "yàn",
  "柴": "chái", "瞿": "qú", "充": "chōng", "慕": "mù", "连": "lián",
  "茹": "rú", "习": "xí", "宦": "huàn", "艾": "ài", "鱼": "yú",
  "向": "xiàng", "古": "gǔ", "慎": "shèn", "戈": "gē", "庾": "yǔ",
  "终": "zhōng", "暨": "jì", "居": "jū", "步": "bù", "都": "dū",
  "耿": "gěng", "满": "mǎn", "匡": "kuāng", "国": "guó", "寇": "kòu",
  "广": "guǎng", "禄": "lù", "阙": "què", "东": "dōng", "欧": "ōu",
  "殳": "shū", "沃": "wò", "利": "lì", "蔚": "wèi", "越": "yuè",
  "夔": "kuí", "隆": "lóng", "师": "shī", "巩": "gǒng", "厍": "shè",
  "聂": "niè", "晁": "cháo", "勾": "gōu", "敖": "áo", "融": "róng",
  "冷": "lěng", "訾": "zǐ", "辛": "xīn", "阚": "kàn", "那": "nā",
  "简": "jiǎn", "饶": "ráo", "空": "kōng", "毋": "wú", "沙": "shā",
  "乜": "niè", "养": "yǎng", "鞠": "jū", "须": "xū", "丰": "fēng",
  "巢": "cháo", "关": "guān", "蒯": "kuǎi", "相": "xiàng", "查": "zhā",
  "后": "hòu", "荆": "jīng", "红": "hóng", "游": "yóu", "竺": "zhú",
  "权": "quán", "逯": "lù", "盖": "gě", "益": "yì", "桓": "huán",
  "公": "gōng",
...
const state = {
  ...
  birthMinute: 0,
  gender: "neutral",
  styles: STYLE_OPTIONS.map((style) => style.id),
  length: "any",
  count: 12,
  names: [],
};
...
function getReferenceItems() {
  ...
  const addReference = (char, source) => {
    const known =
      PARENT_REFERENCE.find((item) => item.c === char) ||
      [...BABY_CHARS.male, ...BABY_CHARS.female, ...POPULAR_CHARS].find((item) => item.c === char);
    refs.push({
      char,
      source,
  ...
  addNameReference(state.father, "父亲");
  addNameReference(state.mother, "母亲");
  return refs;
}
...
function getGroupedReferenceParts() {
  const parts = [];
  ...
  addPart(state.father, "父亲");
  addPart(state.mother, "母亲");
  return parts;
}

function getGroupedReferencePrompt() {
  return getGroupedReferenceParts()
...
function getFourPillars(year, month, day, hour) {
  ...
  const chars = [...pillars.join("")];
  chars.forEach((char) => {
    const element = STEM_ELEMENTS[char] || BRANCH_ELEMENTS[char];
    if (element) counts[element]++;
  });
  const values = Object.entries(counts).filter(([, value]) => value >= 0);
  const min = Math.min(...values.map(([, value]) => value));
  const missing = values.filter(([, value]) => value === 0).map(([key]) => key);
  const weak = values.filter(([, value]) => value === min && value > 0).map(([key]) => key);
  return {
    pillars,
    counts,
    missing,
...
function getWuGe(surname, given) {
  ...
  const surnameStrokes = [...surname.s].map(strokeOf);
...
function getBirthLabel() {
  return `${state.birthYear}年${state.birthMonth}月${state.birthDay}日 ${state.birthTime} · ${getZodiac(state.birthYear)}年 · ${getHourLabel(state.birthHour)}`;
}

function syncBirthFromDate() {
...
function syncBirthFromTime() {
  const [hour, minute] = state.birthTime.split(":").map(Number);
  state.birthHour = hour;
  state.birthMinute = minute;
}

function getElementCountLabel(counts) {
  return `木${counts["木"]} 火${counts["火"]} 土${counts["土"]} 金${counts["金"]} 水${counts["水"]}`;
}

function getReferencePillData() {
  const zodiac = getZodiac(state.birthYear);
  const pillars = getFourPillars(state.birthYear, state.birthMonth, state.birthDay, state.birthHour);
  const gua = getGuaByHour(state.birthHour);
  const boostText = pillars.boost.length
    ? `宜补 ${pillars.boost.join("、")}`
    : "五行均衡";
  return [
    { strong: getBirthLabel() },
    { strong: "八字参考", text: pillars.pillars.join(" ") },
    { strong: "五行", text: `${getElementCountLabel(pillars.counts)} · ${boostText}` },
    { strong: `${getHourLabel(state.birthHour)}卦象`, text: `${gua.name}卦·${gua.symbol}`, note: gua.line },
    { strong: `${zodiac}年宜用`, text: ZODIAC_NOTES[zodiac] || "" },
    { strong: "热门灵感", text: "已融合 2025-2026 高频字与热门名" },
  ];
}

function getReferenceTags(refs) {
  return [...new Set(refs.flatMap((ref) => ref.tags))];
}

function pickBalancedReferences(refs, max) {
  const fatherRefs = refs.filter((ref) => ref.source === "父亲");
  const motherRefs = refs.filter((ref) => ref.source === "母亲");
  const result = [];
  let index = 0;
  while (result.length < max && (index < fatherRefs.length || index < motherRefs.length)) {
    if (index < fatherRefs.length) {
      result.push(fatherRefs[index]);
    }
    if (result.length < max && index < motherRefs.length) {
      result.push(motherRefs[index]);
    }
    index++;
  }
  return result;
...
function getCandidatePool() {
  const genderBase =
    state.gender === "male"
      ...
      : [...BABY_CHARS.male, ...BABY_CHARS.female];
  const popularPool =
    state.gender === "neutral"
      ? POPULAR_CHARS
  ...
  const base = [...genderBase, ...popularPool];
  let pool = [...new Map(base.map((item) => [item.c, item])).values()];
  const excluded = new Set([...state.father.trim(), ...state.mother.trim()]);
  const withoutParentChars = pool.filter((item) => !excluded.has(item.c));
  if (withoutParentChars.length >= 6) {
    pool = withoutParentChars;
  }
  if (state.styles.length) {
    const styled = pool.filter((item) => item.tags.some((tag) => state.styles.includes(tag)));
    if (styled.length >= 6) {
      pool = styled;
    }
  }
...
function getAllCharLookup() {
  const all = [...BABY_CHARS.male, ...BABY_CHARS.female, ...POPULAR_CHARS];
  const map = new Map();
  all.forEach((item) => {
...
function getPopularName(rng, usedChars) {
  if (state.length === "short") return null;
  const lookup = getAllCharLookup();
  const excluded = new Set([...state.father.trim(), ...state.mother.trim()]);
  const genderMatch = (item) =>
    state.gender === "neutral" || item.g === "a" || item.g === state.gender;
  const available = POPULAR_NAMES.filter((item) => {
    ...
    if (state.styles.length && !item.t.some((tag) => state.styles.includes(tag))) return false;
    return true;
  });
  if (!available.length) return null;
  const choice = pick(available, rng);
  return [...choice.n].map((char) => {
    const known = lookup.get(char);
    return (
      known || {
        c: char,
        py: "·",
...
function getSurname() {
  const father = state.father.trim();
  const mother = state.mother.trim();
  ...
  if (state.surnameSource === "father") {
    return make(fatherSurname) || make(motherSurname);
  }
  if (state.surnameSource === "mother") {
    return make(motherSurname) || make(fatherSurname);
  }
  return null;
}

function rankPool(pool, refs, rng) {
  const refTags = getReferenceTags(refs);
  const zodiacKey = `zodiac-${getZodiac(state.birthYear)}`;
  const seasonChars = SEASON_BONUS_CHARS[getSeason(state.birthMonth)] || [];
  const profile = getFourPillars(state.birthYear, state.birthMonth, state.birthDay, state.birthHour);
  const gua = getGuaByHour(state.birthHour);
  return pool
    .map((item) => {
      const overlap = item.tags.filter((tag) => refTags.includes(tag)).length;
      const matchesReference =
        refs.length > 0 && refs.some((ref) => item.meaning.includes(ref.char) || item.meaning.includes(ref.meaning.slice(0, 2)));
...
function pickGivenChars(rng, usedChars = new Set()) {
  const refs = getReferenceItems();
  const pool = getCandidatePool();
  const ranked = rankPool(pool, refs, rng);
  const generationChar = state.generationChar.trim().slice(0, 1);
  let length = state.length === "short" ? 1 : state.length === "long" ? 2 : rng() > 0.35 ? 2 : 1;
  const chosen = [];
  let attempts = 0;

  if (!generationChar && length === 2 && rng() < 0.22) {
    const popular = getPopularName(rng, usedChars);
    if (popular) {
...
function makeName(rng, usedChars = new Set()) {
  const surname = getSurname();
  const given = pickGivenChars(rng, usedChars);
  const refs = getReferenceItems();
  const refLine =
    getGroupedReferencePrompt() ||
    pickBalancedReferences(refs, 4).map((ref) => `${ref.source}「${ref.char}」${ref.meaning}`).join("；");
  const gua = getGuaByHour(state.birthHour);
...
function generateNames() {
  ...
  let attempts = 0;
  while (names.length < state.count && attempts < state.count * 60) {
    attempts++;
    const candidate = makeName(rng, usedChars);
    if (
      candidate.text !== state.father.trim() &&
      candidate.text !== state.mother.trim() &&
      !names.some((item) => item.text === candidate.text)
    ) {
      names.push(candidate);
    }
  }
  while (names.length < state.count) {
    names.push(makeName(rng));
  }
  state.names = names;
  renderNames();
}
...
function renderReferenceStrip() {
  ...
  const parts = getGroupedReferenceParts();
  const pills = getReferencePillData().map((pill) => {
    const title = `<strong>${escapeHtml(pill.strong)}</strong>`;
    const text = pill.text ? `<span>${escapeHtml(pill.text)}</span>` : "";
    const note = pill.note ? `<em>${escapeHtml(pill.note)}</em>` : "";
    return `<span class="ref-pill">${title}${text}${note}</span>`;
  });
  const parentPills = parts.map(
    (part) => `<span class="ref-pill"><strong>${escapeHtml(part.source)}名字中的「${escapeHtml(part.text)}」</strong></span>`
  );
  strip.hidden = false;
  strip.innerHTML = [...pills, ...parentPills].join("");
}
...
function renderNames() {
  ...
  const styleLabels = state.styles.map((id) => STYLE_OPTIONS.find((style) => style.id === id)?.label).filter(Boolean);
  subtitle.textContent = `已生成 ${state.names.length} 个名字 · ${getBirthLabel()} · ${styleLabels.join("、") || "不限风格"}`;

  grid.innerHTML = state.names
    .map((item, index) => {
      const tagHtml = item.tags
        .map((tag, tagIndex) => {
          const style = STYLE_OPTIONS.find((option) => option.id === tag);
          return `<span class="tag${tagIndex === 1 ? " alt" : ""}">${escapeHtml(style ? style.label : tag)}</span>`;
        })
        .join("");
      const refHtml = item.refLine ? `<div class="ref-line">${escapeHtml(item.refLine)}</div>` : "";
      return `
        <article class="name-card" data-index="${index}">
          <div class="card-top">
            <div>
              <div class="name-text">${escapeHtml(item.text)}</div>
              <div class="name-sub">${escapeHtml(item.pinyin)}</div>
            </div>
            <div class="card-actions">
              <button class="mini-button" data-action="copy" type="button" title="复制名字" aria-label="复制名字">${iconSvg("copy")}</button>
              <button class="mini-button" data-action="refresh" type="button" title="换一个" aria-label="换一个">${iconSvg("refresh")}</button>
            </div>
          </div>
          ${refHtml}
          <p class="name-meaning">${escapeHtml(item.meaning)}</p>
          <div class="insight-line">${escapeHtml(item.insight)}</div>
          <div class="wuge-line">${escapeHtml(item.wuge)}</div>
          <div class="classic-line">${escapeHtml(item.classic)}</div>
          <div class="card-foot">
...
function bindEvents() {
  document.getElementById("fatherInput").addEventListener("input", (event) => {
    state.father = event.target.value;
    generateNames();
  });

  document.getElementById("motherInput").addEventListener("input", (event) => {
    state.mother = event.target.value;
    generateNames();
  });

  document.getElementById("surnameTabs").addEventListener("click", (event) => {
    const button = event.target.closest("[data-source]");
    if (!button) return;
    state.surnameSource = button.dataset.source;
    document.querySelectorAll("#surnameTabs .segment").forEach((segment) => {
      segment.classList.toggle("active", segment === button);
    });
    generateNames();
  });

  const generationInput = document.getElementById("generationChar");
  generationInput.addEventListener("input", (event) => {
    state.generationChar = event.target.value;
    clearTimeout(generationInput._timer);
    generationInput._timer = setTimeout(generateNames, 250);
  });
  ...
  document.getElementById("birthTime").addEventListener("change", (event) => {
    state.birthTime = event.target.value;
    syncBirthFromTime();
    generateNames();
  });
  ...
  document.getElementById("genderTabs").addEventListener("click", (event) => {
    ...
    document.querySelectorAll("#genderTabs .segment").forEach((segment) => {
      segment.classList.toggle("active", segment === button);
    });
    generateNames();
  });

  document.getElementById("styleChips").addEventListener("click", (event) => {
    const button = event.target.closest("[data-style]");
    if (!button) return;
    const style = button.dataset.style;
    if (state.styles.includes(style)) {
      state.styles = state.styles.filter((item) => item !== style);
  ...
  document.getElementById("lengthTabs").addEventListener("click", (event) => {
    const button = event.target.closest("[data-length]");
    if (!button) return;
    state.length = button.dataset.length;
    document.querySelectorAll("#lengthTabs .segment").forEach((segment) => {
      segment.classList.toggle("active", segment === button);
    });
    generateNames();
  });
  ...
  const syncRange = () => {
    ...
    const percent = ((state.count - Number(countRange.min)) / (Number(countRange.max) - Number(countRange.min))) * 100;
    countRange.style.background = `linear-gradient(90deg, var(--teal) 0 ${percent}%, var(--paper-deep) ${percent}%)`;
    generateNames();
  };
  countRange.addEventListener("input", syncRange);

  document.getElementById("generateButton").addEventListener("click", generateNames);
  document.getElementById("shuffleButton").addEventListener("click", generateNames);

  document.getElementById("nameGrid").addEventListener("click", async (event) => {
    const button = event.target.closest("[data-action]");
    if (!button) return;
    const card = button.closest(".name-card");
    const index = Number(card.dataset.index);
    if (button.dataset.action === "copy") {
      await copyText(state.names[index].text);
